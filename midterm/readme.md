...
The input is the motion being detected, the output will then be to generate a random number from 0-100. While the number is generating, the LEDs will alternate from Blue LED to White LED. This will happen for five seconds. 
